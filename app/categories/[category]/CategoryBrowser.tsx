      ...
      <div className="mb-8 flex flex-col sm:flex-row gap-3">
        <form onSubmit={search} className="flex gap-2 flex-1">
          <input
            ...
            className={inputCls}
          />
          <button type="submit" className="bg-ink text-paper px-5 py-3 text-sm font-semibold border border-ink/10 rounded-full shadow-hard hover:bg-accent hover:border-accent transition-colors whitespace-nowrap">
            Buscar
          </button>
        </form>
        <label className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-widest text-ink/60">
          ...
          <select
            ...
            className="bg-paper border border-ink/10 rounded-xl px-3 py-3 text-ink text-sm focus:outline-none cursor-pointer"
          >
            {SORT_OPTIONS.map((o) => (
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          {subFilters.map((s) => (
            <Link
              ...
              className="px-3.5 py-1.5 text-[11px] font-semibold border border-ink/10 rounded-full bg-paper text-ink hover:bg-ink hover:text-paper transition-colors"
            >
