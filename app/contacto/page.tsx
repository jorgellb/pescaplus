      ...
      <section className="max-w-4xl mx-auto px-4 py-10 sm:px-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside className="space-y-6">
          <div className="border border-ink/10 rounded-xl bg-paper p-5 space-y-2">
            <h2 className="font-mono text-[11px] font-bold uppercase tracking-widest text-ink/60">Antes de escribir</h2>
          ...
          <div className="border border-ink/10 rounded-xl bg-paper p-5 space-y-2">
            <h2 className="font-mono text-[11px] font-bold uppercase tracking-widest text-ink/60">Sobre las compras</h2>
            <p className="text-sm text-ink/70 leading-relaxed">
