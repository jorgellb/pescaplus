          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {guides.map((g) => (
              <Link
                key={g.id}
                href={`/guias/${g.id}`}
                className="group flex flex-col bg-paper border border-ink/10 rounded-xl shadow-hard hover-shift"
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-ink/[0.05] border-b border-ink/[0.07]">
