      ...
      {operators.map((o) => (
        <div key={o.id} className={`border rounded-2xl p-4 ${o.verified ? 'border-accent/30 bg-accent/[0.04]' : 'border-amber-700/30 bg-amber-700/[0.05]'}`}>
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="font-bold text-ink">{o.businessName || o.name} <span className="font-mono text-[10px] uppercase tracking-widest text-ink/60 inline-flex items-center gap-1">
